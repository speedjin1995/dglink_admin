                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                if($totalSCages <= 0){
                                                                    ...
                                                                    $message .= '<td style="width: 20%;border-top:0px;padding: 0 0.7rem;border: 1px solid #000000;font-size: 12px;font-family: sans-serif;text-align: center;">' . ($totalSBirds > 0 ? number_format($totalSNet / $totalSBirds, 2, '.', '') : '0.00') . '</td>';
                                                                }
                                                                ...
                                                                if($totalACages <= 0){
                                                                    ...
                                                                    $message .= '<td style="width: 20%;border-top:0px;padding: 0 0.7rem;border: 1px solid #000000;font-size: 12px;font-family: sans-serif;text-align: center;">' . ($totalABirds > 0 ? number_format($totalANet / $totalABirds, 2, '.', '') : '0.00') . '</td>';
                                                                }
                                                                ...
                                                                if($totalBirds <= 0){
                                                                    ...
                                                                    $message .= '<td style="width: 20%;border-top:0px;padding: 0 0.7rem;border: 1px solid #000000;font-size: 12px;font-family: sans-serif;text-align: center;">' . ($totalBirds > 0 ? number_format($totalNet / $totalBirds, 2, '.', '') : '0.00') . '</td>';
                                                                }
                                                            $message.= '</tr>
                                                            <tr>
                                                                ...
                                                                if (count($mapOfBirdsToCages) > 0) {
                                                                    ...
                                                                    foreach ($mapOfBirdsToCages as $bc) {
                                                                        $message .= '
                                                                            <tr>
                                                                                ...
                                                                                <td style="width: 25%;border-top:0px;padding: 0 0.7rem;border: 1px solid #000000;font-size: 12px;font-family: sans-serif;text-align: center !important;">'.$bc['count'].'</td>
                                                                                <td style="width: 25%;border-top:0px;padding: 0 0.7rem;border: 1px solid #000000;font-size: 12px;font-family: sans-serif;text-align: center !important;">'.((int)$bc['count'] * (int)$bc['numberOfBirds']).'</td>
                                                                            </tr>
                                                                        ';
                                                                    ...
                                                                    $message .= '
                                                                            <tr>
                                                                                ...
                                                                                <td style="width: 25%;border-top:0px;padding: 0 0.7rem;border: 1px solid #000000;font-size: 12px;font-family: sans-serif;text-align: center !important;">'.$totalCages.'</td>
                                                                                <td style="width: 25%;border-top:0px;padding: 0 0.7rem;border: 1px solid #000000;font-size: 12px;font-family: sans-serif;text-align: center !important;">'.$totalBirdsInCages.'</td>
                                                                            </tr>
                                                                        ';
                                                                }
                                                            ...
                                                            <tbody>
                                                                ...
                                                                if (count($groupMapOfBirdsToCages) > 0) {
                                                                    ...
                                                                    $message .= '
                                                                            <tr>
                                                                                <td style="width: 25%;border-top:0px;padding: 0 0.7rem;border: 1px solid #000000;font-size: 12px;font-family: sans-serif;text-align: center !important;"><b>Total</b></td>
                                                                                <td style="width: 25%;border-top:0px;padding: 0 0.7rem;border: 1px solid #000000;font-size: 12px;font-family: sans-serif;text-align: center !important;">'.$groupTotalCages.'</td>
                                                                                <td style="width: 25%;border-top:0px;padding: 0 0.7rem;border: 1px solid #000000;font-size: 12px;font-family: sans-serif;text-align: center !important;">'.$groupTotalBirdsInCages.'</td>
                                                                            </tr>
                                                                        ';
                                                                }
            ...
            PagedPolyfill.preview().then(() => {
                ...
                setTimeout(() => {
                    ...
                    $(".pagedjs_page").each(function () {
                        ...
                        // Find element with ID like record-1, record-2, etc.
                        const $recordEl = $page.find("[id^=\'record-\']").first();
                        if ($recordEl.length === 0) return;

                        // Extract record ID from id="record-1"
                        const match = $recordEl.attr("id").match(/record-(\d+)/);
                        if (!match) return;

                        const recordId = match[1];
                        $page.attr("data-record-id", recordId);

                        if (!recordPagesMap[recordId]) {
                            recordPagesMap[recordId] = [];
                        }
                        recordPagesMap[recordId].push($page);
                    });

                    // Update page numbers
                    $.each(recordPagesMap, function (recordId, pageList) {
                        const totalPages = pageList.length;

                        pageList.forEach(function ($page, index) {
                            const pageNo = index + 1;

                            const $pageNumberEl = $page.find("#page-number-" + recordId);
                            const $totalPagesEl = $page.find("#total-pages-" + recordId);

                            if ($pageNumberEl.length) $pageNumberEl.text(pageNo);
